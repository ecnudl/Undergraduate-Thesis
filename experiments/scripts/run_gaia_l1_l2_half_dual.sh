...
EVAL_DIR="./experiments/results/gaia_dual_eval_${TIMESTAMP}"
...
# Keep the launch style aligned with the existing repo scripts, but pin the
# API/base/model for this experiment family explicitly so .env does not
# accidentally switch it back to another provider.
...
# Restrict the process to one physical GPU. Inside the process this becomes
# cuda:0, but it maps to the user-selected physical GPU in CUDA_VISIBLE_DEVICES.
...
echo "============================================================"
echo "  GAIA Dual Evaluation — Tip+Insight vs No Memory"
echo "============================================================"
...
echo "  Embedding:   ${MEMORY_EMBEDDING_DEVICE}"
echo "============================================================"
echo ""
