...
EVAL_DIR="./experiments/results/gaia_workflow_semantic_eval_${TIMESTAMP}"
INFILE="./data/gaia/validation/metadata.jsonl"
TASK_INDICES="${TASK_INDICES:-[level1]1-10 [level2]1-10 [level3]1-4}"
...
WORKFLOW_NAME="gaia_workflow_shortcut_hybrid_semantic_json_full"
...
echo "============================================================"
echo "  GAIA Evaluation — No Memory vs Workflow+Shortcut"
echo "============================================================"
