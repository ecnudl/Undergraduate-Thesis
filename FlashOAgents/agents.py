...
class MultiStepAgent:
    ...
    def planning_step(self, task) -> None:
        ...
        if memory_guidance_content:
            formatted_memory = (
                "————Memory System Reference (Optional)————\n"
                "Below are lessons from previous tasks. They may or may not be relevant to your current task. "
                "Use them ONLY if they clearly apply. Ignore any that seem unrelated to your specific problem — "
                "your own reasoning about the current task should take priority over these references.\n\n"
